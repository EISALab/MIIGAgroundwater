...
#@ wall_clock_limit = 60:00:00, 59:45:00
...
save_files () {
  ...
  cd $SCR
  msscmd cd /u/ac/evasinha/uma_multiscale_II, put test106_coarse.res
  msscmd cd /u/ac/evasinha/uma_multiscale_II, put test106_coarse.chn
  msscmd cd /u/ac/evasinha/uma_multiscale_II, put test106_coarse.out 
  msscmd cd /u/ac/evasinha/uma_multiscale_II, put test106_coarse.cr0
  msscmd cd /u/ac/evasinha/uma_multiscale_II, put nn_coarse
  msscmd cd /u/ac/evasinha/uma_multiscale_II, put test106_fine.res
  msscmd cd /u/ac/evasinha/uma_multiscale_II, put test106_fine.chn
  msscmd cd /u/ac/evasinha/uma_multiscale_II, put test106_fine.out 
  msscmd cd /u/ac/evasinha/uma_multiscale_II, put test106_fine.cr0
  msscmd cd /u/ac/evasinha/uma_multiscale_II, put nn_fine
