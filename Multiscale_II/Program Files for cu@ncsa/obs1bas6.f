...
c     APPEND_PID called by Eva Sinha
            ...
            OPEN(IOUB,FILE=FILENAME,ERR=20)
C            OPEN(IOUB,FILE=FN,ERR=20)
...
C     APPEND_PID called by Eva Sinha
      ...
      CALL APPEND_PID(FILENAME)
      IF (IUSS.GT.0) THEN
         OPEN(IUSS,FILE=FILENAME,ERR=150)
c        OPEN(IUSS,FILE=FN,ERR=150)
      ELSE
        GOTO 150
      ENDIF
  140 CONTINUE
