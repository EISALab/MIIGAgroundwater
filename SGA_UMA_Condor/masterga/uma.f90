...
1116 format(7f5.0,2x,14f3.0)
  ...
  write(*,*) 'npopsiz, maxgen, gridflagx, feed, irestrt'
  write(*,*)  npopsiz, maxgen, gridflagx, feed, irestrt
  write(74,*) 'npopsiz, maxgen, gridflagx, feed, irestrt'
  write(74,*)  npopsiz, maxgen, gridflagx, feed, irestrt
  write (74,*)
  write (74,*)
...
1116      format(i4,2x,7i5,2x,7i3,3x,7i3)
        ...
        do z = 1,npopsiz
			...
			call BroadcastSlave(z, ig+1, gridflagx, gridflagy )
		enddo
        ...
        do z = 1,npopsiz
			...
			call CollectSlave( z, ig+1, Fitness1, Total_cost,Pen_Rdx,Pen_Tnt, drycell_c, drycell_h)
...
!  Initialize rand_xom number generator
    call ran2(idum1,rand_x)  !Changed by F. Espinoza (4/10/03)
...
!parents when irestrt=0.
     if(.not.irestrt) then
        ...
        do i=1,npopsiz
           do j=1,nchrome
              call ran2(1,rand_x) !Changed by F. Espinoza (4/10/03)
