C
      SUBROUTINE GCG4AL(INGCG,IOUT,ISUM,ISUM2,NCOL,NROW,NLAY,MXITER,
...
C
C
      SUBROUTINE GCG4RP(INGCG,IOUT,MXITER,ITER1,
...
C
C
      SUBROUTINE GCG4AP(IOUT,MXITER,ITER1,ITO,ITP,METHOD,RELAX,CCLOSE,
...
C--STORE MAXIMUM CHANGE VALUE AND LOCATION
      ...
      JCOLMN = IJ - (IROW-1)*NCOL
        ...
        LRCH(3,ITP) = JCOLMN
C
C     Added by Abhishek Singh and Eva Sinha to supress screen output
C      WRITE(*,1111) ITO,LITP,CHANGE,KLAYER,IROW,JCOLMN
