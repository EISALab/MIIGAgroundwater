...
public:
	...
	typedef BOOL (*TW_FUNC)(TYPE& data, LPVOID lpParam );
...
//	void AddTree(CObBintree* pNewBinTree);
	...
	void WalkTree( TW_FUNC pfnVisit, LPVOID lpParam=NULL, int nTvOrder=TV_INORDER );
...
template<typename TYPE, typename ARG_TYPE, typename ARG_KEY, class ETraits>
typename CBinTree<TYPE, ARG_TYPE, ARG_KEY, ETraits>::TW_FUNC CBinTree<TYPE, ARG_TYPE, ARG_KEY, ETraits>::m_pfnVisit = NULL;
template<typename TYPE, typename ARG_TYPE, typename ARG_KEY, class ETraits>
...
template< typename TYPE, typename ARG_TYPE, typename ARG_KEY, class ETraits >
typename CBinTree<TYPE, ARG_TYPE, ARG_KEY, ETraits>::CNode*
CBinTree<TYPE, ARG_TYPE, ARG_KEY, ETraits>::NewNode(typename CBinTree<TYPE, ARG_TYPE, ARG_KEY, ETraits>::CNode* pParent, typename CBinTree<TYPE, ARG_TYPE, ARG_KEY, ETraits>::CNode* pLChild, typename CBinTree<TYPE, ARG_TYPE, ARG_KEY, ETraits>::CNode* pRChild)
{
	if (m_pNodeFree == NULL)
	{
		// add another block
...
template<typename TYPE, typename ARG_TYPE, typename ARG_KEY, class ETraits>
void CBinTree<TYPE, ARG_TYPE, ARG_KEY, ETraits>::WalkTree( CBinTree<TYPE, ARG_TYPE, ARG_KEY, ETraits>::TW_FUNC pfnVisit, LPVOID lpParam, int nTvOrder )
{
...
template<typename TYPE, typename ARG_TYPE, typename ARG_KEY, class ETraits>
typename CAvlTree<TYPE, ARG_TYPE, ARG_KEY, ETraits>::TW_FUNC CAvlTree<TYPE, ARG_TYPE, ARG_KEY, ETraits>::m_pfnVisit = NULL;
template<typename TYPE, typename ARG_TYPE, typename ARG_KEY, class ETraits>
...
template<typename TYPE, typename ARG_TYPE, typename ARG_KEY, class ETraits>
typename CAvlTree<TYPE, ARG_TYPE, ARG_KEY, ETraits>::CNode*
CAvlTree<TYPE, ARG_TYPE, ARG_KEY, ETraits>::NewNode(typename CAvlTree<TYPE, ARG_TYPE, ARG_KEY, ETraits>::CNode* pParent, typename CAvlTree<TYPE, ARG_TYPE, ARG_KEY, ETraits>::CNode* pLChild, typename CAvlTree<TYPE, ARG_TYPE, ARG_KEY, ETraits>::CNode* pRChild)
{
	if (m_pNodeFree == NULL)
	{
		// add another block
...
template<typename TYPE, typename ARG_TYPE, typename ARG_KEY, class ETraits>
void CAvlTree<TYPE, ARG_TYPE, ARG_KEY, ETraits>::WalkTree( CAvlTree<TYPE, ARG_TYPE, ARG_KEY, ETraits>::TW_FUNC pfnVisit, LPVOID lpParam, int nTvOrder )
{
	ASSERT( pfnVisit!=NULL );
