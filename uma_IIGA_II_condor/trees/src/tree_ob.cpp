...
CObBinTree::TW_FUNC CObBinTree::m_pfnVisit = NULL;
BOOL CObBinTree::m_bTvStop = FALSE;
/////////////////////////////////////////////////////////////////////////////
LPVOID CObAvlTree::m_lpTvParam = NULL;
CObAvlTree::TW_FUNC CObAvlTree::m_pfnVisit = NULL;
...
void CObBinTree::WalkTree( CObBinTree::TW_FUNC pfnVisit, LPVOID lpParam, int nTvOrder )
{
...
void CObAvlTree::WalkTree( CObAvlTree::TW_FUNC pfnVisit, LPVOID lpParam, int nTvOrder )
{
	ASSERT( pfnVisit!=NULL );
